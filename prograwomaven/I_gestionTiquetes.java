 ...
 * @author Orlando
 */
public class I_gestionTiquetes extends javax.swing.JFrame {

    /**
     * Creates new form gestionTiquetes
     */
    public I_gestionTiquetes() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(I_gestionTiquetes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new I_gestionTiquetes().setVisible(true);
            }
        });
    }
