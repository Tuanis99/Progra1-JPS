...
public class Ff_consultarSorteo extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        while (A_InicioPrograma.JPSDATA.current!=null){
            if (A_InicioPrograma.JPSDATA.current.getElement().codigo.equals(entrada)){
                encontrado =true;
                break;
            }
            A_InicioPrograma.JPSDATA.current = A_InicioPrograma.JPSDATA.current.getNext();
        ...
        if(encontrado==false){  
            JOptionPane.showMessageDialog(null,"La libraría no existe", "No existe librería",JOptionPane.PLAIN_MESSAGE);
        } 
        else{
            this.dispose();
            //Nueva ventana
            Ff_BusquedaSorteo apartado_libreria = new Ff_BusquedaSorteo(entrada);
            apartado_libreria.setTitle("Ventana Pedidos");
            apartado_libreria.setVisible(true);
            apartado_libreria.setLocationRelativeTo(null);
            apartado_libreria.setDefaultCloseOperation(Ff_BusquedaSorteo.HIDE_ON_CLOSE);
           //Valores de la libreria
            ...
            Ff_BusquedaSorteo.ResultadoESorteo.setText(A_InicioPrograma.JPSDATA.current.element.emisiones);
            Ff_BusquedaSorteo.ResultadoFSorteo.setText(A_InicioPrograma.JPSDATA.current.element.fechaSorteo);
